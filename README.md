...
For this homework we'll be creating a visualization dashboard website using visualizations we've created in a past assignment. Specifically, we'll be plotting [weather data](https://github.com/AR-Elbers/python-api-challenge).
...
* You may use the [weather data](https://github.com/AR-Elbers/python-api-challenge/blob/main/output_data/WeatherPy_data.csv) or choose another dataset. Alternatively, you may use the included [cities dataset](Resources/cities.csv) and pull the images from the [assets folder](Resources/assets).
